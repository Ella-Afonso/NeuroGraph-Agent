...
|---|---|
| Symbol | RAB7A |
| Approved Name | RAB7A, member RAS oncogene family |
| Target ID | ENSG00000075785 |
| Biotype | protein_coding |
| Association Score | 0.4748 |
| Gap Score | 0.1070 |
| Conservative Gap Score | 0.1337 |
| Gap Rank | 119 |
...
**Lower evidence signal** (association score: 0.4748)
