...
|---|---|
| Symbol | GAK |
| Approved Name | cyclin G associated kinase |
| Target ID | ENSG00000178950 |
| Biotype | protein_coding |
| Association Score | 0.3718 |
| Gap Score | 0.0305 |
| Conservative Gap Score | 0.0382 |
| Gap Rank | 334 |
...
**Lower evidence signal** (association score: 0.3718)
...
- Symbol 'GAK' has a moderate ambiguity flag — mention counts are especially uncertain.
