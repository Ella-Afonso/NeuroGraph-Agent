...
|---|---|
| Symbol | DIMT1 |
| Approved Name | DIM1 rRNA methyltransferase and ribosome maturation factor |
| Target ID | ENSG00000086189 |
| Biotype | protein_coding |
| Association Score | 0.4585 |
| Gap Score | 0.0949 |
| Conservative Gap Score | 0.1186 |
| Gap Rank | 175 |
...
**Lower evidence signal** (association score: 0.4585)
