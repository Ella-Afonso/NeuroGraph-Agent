...
|---|---|
| Symbol | KHDRBS2 |
| Approved Name | KH RNA binding domain containing, signal transduction associated 2 |
| Target ID | ENSG00000112232 |
| Biotype | protein_coding |
| Association Score | 0.3572 |
| Gap Score | 0.0197 |
| Conservative Gap Score | 0.0246 |
| Gap Rank | 397 |
...
**Lower evidence signal** (association score: 0.3572)
