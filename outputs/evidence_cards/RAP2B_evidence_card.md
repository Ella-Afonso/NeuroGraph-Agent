...
|---|---|
| Symbol | RAP2B |
| Approved Name | RAP2B, member of RAS oncogene family |
| Target ID | ENSG00000181467 |
| Biotype | protein_coding |
| Association Score | 0.4366 |
| Gap Score | 0.0786 |
| Conservative Gap Score | 0.0982 |
| Gap Rank | 207 |
...
**Lower evidence signal** (association score: 0.4366)
