...
|---|---|
| Symbol | PAPSS1 |
| Approved Name | 3'-phosphoadenosine 5'-phosphosulfate synthase 1 |
| Target ID | ENSG00000138801 |
| Biotype | protein_coding |
| Association Score | 0.3387 |
| Gap Score | 0.0060 |
| Conservative Gap Score | 0.0074 |
| Gap Rank | 458 |
...
**Lower evidence signal** (association score: 0.3387)
