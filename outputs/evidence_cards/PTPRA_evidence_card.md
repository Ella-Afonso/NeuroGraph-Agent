...
|---|---|
| Symbol | PTPRA |
| Approved Name | protein tyrosine phosphatase receptor type A |
| Target ID | ENSG00000132670 |
| Biotype | protein_coding |
| Association Score | 0.3829 |
| Gap Score | 0.0388 |
| Conservative Gap Score | 0.0485 |
| Gap Rank | 290 |
...
**Lower evidence signal** (association score: 0.3829)
