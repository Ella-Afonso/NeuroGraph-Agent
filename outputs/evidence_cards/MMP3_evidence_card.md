...
|---|---|
| Symbol | MMP3 |
| Approved Name | matrix metallopeptidase 3 |
| Target ID | ENSG00000149968 |
| Biotype | protein_coding |
| Association Score | 0.3558 |
| Gap Score | 0.0187 |
| Conservative Gap Score | 0.0233 |
| Gap Rank | 401 |
...
**Lower evidence signal** (association score: 0.3558)
