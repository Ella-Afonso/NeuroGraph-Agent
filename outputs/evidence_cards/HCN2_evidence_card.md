...
|---|---|
| Symbol | HCN2 |
| Approved Name | hyperpolarization activated cyclic nucleotide gated potassium and sodium channel 2 |
| Target ID | ENSG00000099822 |
| Biotype | protein_coding |
| Association Score | 0.3401 |
| Gap Score | 0.0070 |
| Conservative Gap Score | 0.0087 |
| Gap Rank | 453 |
...
**Lower evidence signal** (association score: 0.3401)
