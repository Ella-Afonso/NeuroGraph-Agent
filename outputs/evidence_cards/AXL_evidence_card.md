...
|---|---|
| Symbol | AXL |
| Approved Name | AXL receptor tyrosine kinase |
| Target ID | ENSG00000167601 |
| Biotype | protein_coding |
| Association Score | 0.5344 |
| Gap Score | 0.1512 |
| Conservative Gap Score | 0.1890 |
| Gap Rank | 58 |
...
**Moderate evidence signal** (association score: 0.5344)
...
- Symbol 'AXL' has a moderate ambiguity flag — mention counts are especially uncertain.
