...
|---|---|
| Symbol | COX7C |
| Approved Name | cytochrome c oxidase subunit 7C |
| Target ID | ENSG00000127184 |
| Biotype | protein_coding |
| Association Score | 0.4124 |
| Gap Score | 0.0607 |
| Conservative Gap Score | 0.0758 |
| Gap Rank | 236 |
...
**Lower evidence signal** (association score: 0.4124)
