...
|---|---|
| Symbol | SDK1 |
| Approved Name | sidekick cell adhesion molecule 1 |
| Target ID | ENSG00000146555 |
| Biotype | protein_coding |
| Association Score | 0.3581 |
| Gap Score | 0.0203 |
| Conservative Gap Score | 0.0254 |
| Gap Rank | 395 |
...
**Lower evidence signal** (association score: 0.3581)
