...
|---|---|
| Symbol | PIK3R2 |
| Approved Name | phosphoinositide-3-kinase regulatory subunit 2 |
| Target ID | ENSG00000105647 |
| Biotype | protein_coding |
| Association Score | 0.3537 |
| Gap Score | 0.0171 |
| Conservative Gap Score | 0.0214 |
| Gap Rank | 406 |
...
**Lower evidence signal** (association score: 0.3537)
