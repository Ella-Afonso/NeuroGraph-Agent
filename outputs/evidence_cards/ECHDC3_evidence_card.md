...
|---|---|
| Symbol | ECHDC3 |
| Approved Name | enoyl-CoA hydratase domain containing 3 |
| Target ID | ENSG00000134463 |
| Biotype | protein_coding |
| Association Score | 0.4488 |
| Gap Score | 0.0876 |
| Conservative Gap Score | 0.1096 |
| Gap Rank | 191 |
...
**Lower evidence signal** (association score: 0.4488)
