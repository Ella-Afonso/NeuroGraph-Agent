...
|---|---|
| Symbol | PPP1CB |
| Approved Name | protein phosphatase 1 catalytic subunit beta |
| Target ID | ENSG00000213639 |
| Biotype | protein_coding |
| Association Score | 0.3588 |
| Gap Score | 0.0209 |
| Conservative Gap Score | 0.0261 |
| Gap Rank | 393 |
...
**Lower evidence signal** (association score: 0.3588)
