...
|---|---|
| Symbol | MTHFD1L |
| Approved Name | methylenetetrahydrofolate dehydrogenase (NADP+ dependent) 1 like |
| Target ID | ENSG00000120254 |
| Biotype | protein_coding |
| Association Score | 0.3432 |
| Gap Score | 0.0093 |
| Conservative Gap Score | 0.0117 |
| Gap Rank | 442 |
...
**Lower evidence signal** (association score: 0.3432)
