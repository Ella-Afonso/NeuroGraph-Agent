...
|---|---|
| Symbol | NDUFB9 |
| Approved Name | NADH:ubiquinone oxidoreductase subunit B9 |
| Target ID | ENSG00000147684 |
| Biotype | protein_coding |
| Association Score | 0.4689 |
| Gap Score | 0.1026 |
| Conservative Gap Score | 0.1282 |
| Gap Rank | 127 |
...
**Lower evidence signal** (association score: 0.4689)
