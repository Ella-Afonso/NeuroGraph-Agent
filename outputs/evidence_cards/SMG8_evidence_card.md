...
|---|---|
| Symbol | SMG8 |
| Approved Name | SMG8 nonsense mediated mRNA decay factor |
| Target ID | ENSG00000167447 |
| Biotype | protein_coding |
| Association Score | 0.4471 |
| Gap Score | 0.0864 |
| Conservative Gap Score | 0.1080 |
| Gap Rank | 195 |
...
**Lower evidence signal** (association score: 0.4471)
