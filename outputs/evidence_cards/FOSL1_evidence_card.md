...
|---|---|
| Symbol | FOSL1 |
| Approved Name | FOS like 1, AP-1 transcription factor subunit |
| Target ID | ENSG00000175592 |
| Biotype | protein_coding |
| Association Score | 0.3823 |
| Gap Score | 0.0383 |
| Conservative Gap Score | 0.0479 |
| Gap Rank | 292 |
...
**Lower evidence signal** (association score: 0.3823)
