...
|---|---|
| Symbol | GRIN3B |
| Approved Name | glutamate ionotropic receptor NMDA type subunit 3B |
| Target ID | ENSG00000116032 |
| Biotype | protein_coding |
| Association Score | 0.6694 |
| Gap Score | 0.2513 |
| Conservative Gap Score | 0.3142 |
| Gap Rank | 19 |
...
**Moderate evidence signal** (association score: 0.6694)
