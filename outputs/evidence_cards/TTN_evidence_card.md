...
| Symbol | TTN |
| Approved Name | titin |
| Target ID | ENSG00000155657 |
| Biotype | protein_coding |
| Association Score | 0.4226 |
| Gap Score | 0.0682 |
| Conservative Gap Score | 0.0853 |
| Gap Rank | 224 |
...
**Lower evidence signal** (association score: 0.4226)
...
- Symbol 'TTN' has a moderate ambiguity flag — mention counts are especially uncertain.
