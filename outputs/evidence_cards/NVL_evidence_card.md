...
|---|---|
| Symbol | NVL |
| Approved Name | nuclear VCP like |
| Target ID | ENSG00000143748 |
| Biotype | protein_coding |
| Association Score | 0.3696 |
| Gap Score | 0.0289 |
| Conservative Gap Score | 0.0361 |
| Gap Rank | 357 |
...
**Lower evidence signal** (association score: 0.3696)
...
- Symbol 'NVL' has a moderate ambiguity flag — mention counts are especially uncertain.
