...
|---|---|
| Symbol | NDUFS2 |
| Approved Name | NADH:ubiquinone oxidoreductase core subunit S2 |
| Target ID | ENSG00000158864 |
| Biotype | protein_coding |
| Association Score | 0.5111 |
| Gap Score | 0.1339 |
| Conservative Gap Score | 0.1673 |
| Gap Rank | 82 |
...
**Moderate evidence signal** (association score: 0.5111)
