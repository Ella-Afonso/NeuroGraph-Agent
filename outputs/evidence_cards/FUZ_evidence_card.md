...
|---|---|
| Symbol | FUZ |
| Approved Name | fuzzy planar cell polarity protein |
| Target ID | ENSG00000010361 |
| Biotype | protein_coding |
| Association Score | 0.3386 |
| Gap Score | 0.0059 |
| Conservative Gap Score | 0.0073 |
| Gap Rank | 460 |
...
**Lower evidence signal** (association score: 0.3386)
...
- Symbol 'FUZ' has a moderate ambiguity flag — mention counts are especially uncertain.
