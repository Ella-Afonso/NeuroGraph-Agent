...
|---|---|
| Symbol | MAP2K4 |
| Approved Name | mitogen-activated protein kinase kinase 4 |
| Target ID | ENSG00000065559 |
| Biotype | protein_coding |
| Association Score | 0.3694 |
| Gap Score | 0.0287 |
| Conservative Gap Score | 0.0359 |
| Gap Rank | 360 |
...
**Lower evidence signal** (association score: 0.3694)
