...
|---|---|
| Symbol | ABCA1 |
| Approved Name | ATP binding cassette subfamily A member 1 |
| Target ID | ENSG00000165029 |
| Biotype | protein_coding |
| Association Score | 0.4369 |
| Gap Score | 0.0788 |
| Conservative Gap Score | 0.0985 |
| Gap Rank | 204 |
...
**Lower evidence signal** (association score: 0.4369)
