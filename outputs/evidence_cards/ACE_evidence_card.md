...
|---|---|
| Symbol | ACE |
| Approved Name | angiotensin I converting enzyme |
| Target ID | ENSG00000159640 |
| Biotype | protein_coding |
| Association Score | 0.6342 |
| Gap Score | 0.3047 |
| Conservative Gap Score | 0.3448 |
| Gap Rank | 13 |
...
**Moderate evidence signal** (association score: 0.6342)
...
**Dominant literature themes:** Neuroinflammation & Immune

## 4. Clinical Trial Signal

**Moderate trial text signal**

In this retrieved trial corpus, the target symbol was detected 4 time(s) across 1 registration(s).
...
ACE appears well represented in both literature and trial text in this corpus. It should be treated as an established or trial-covered comparator rather than a gap candidate. It may serve as a reference point for comparing less-studied targets. Note: the symbol 'ACE' may be ambiguous in biomedical or general text; mention counts require manual validation to exclude false positives.
...
| --- | --- | --- | --- | --- |
| GWAS on family history of Alzheimer’s disease | 2018 | 532 | bioRxiv | Neuroinflammation & Immune |
...
- Symbol 'ACE' has a moderate ambiguity flag — mention counts are especially uncertain.
