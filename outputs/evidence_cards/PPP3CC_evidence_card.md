...
|---|---|
| Symbol | PPP3CC |
| Approved Name | protein phosphatase 3 catalytic subunit gamma |
| Target ID | ENSG00000120910 |
| Biotype | protein_coding |
| Association Score | 0.3743 |
| Gap Score | 0.0324 |
| Conservative Gap Score | 0.0405 |
| Gap Rank | 312 |
...
**Lower evidence signal** (association score: 0.3743)
