...
|---|---|
| Symbol | NDUFB6 |
| Approved Name | NADH:ubiquinone oxidoreductase subunit B6 |
| Target ID | ENSG00000165264 |
| Biotype | protein_coding |
| Association Score | 0.3728 |
| Gap Score | 0.0313 |
| Conservative Gap Score | 0.0391 |
| Gap Rank | 322 |
...
**Lower evidence signal** (association score: 0.3728)
