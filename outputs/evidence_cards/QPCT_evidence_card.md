...
|---|---|
| Symbol | QPCT |
| Approved Name | glutaminyl-peptide cyclotransferase |
| Target ID | ENSG00000115828 |
| Biotype | protein_coding |
| Association Score | 0.4051 |
| Gap Score | 0.0553 |
| Conservative Gap Score | 0.0691 |
| Gap Rank | 244 |
...
**Lower evidence signal** (association score: 0.4051)
