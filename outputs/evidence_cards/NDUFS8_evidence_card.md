...
|---|---|
| Symbol | NDUFS8 |
| Approved Name | NADH:ubiquinone oxidoreductase core subunit S8 |
| Target ID | ENSG00000110717 |
| Biotype | protein_coding |
| Association Score | 0.4697 |
| Gap Score | 0.1032 |
| Conservative Gap Score | 0.1290 |
| Gap Rank | 125 |
...
**Lower evidence signal** (association score: 0.4697)
