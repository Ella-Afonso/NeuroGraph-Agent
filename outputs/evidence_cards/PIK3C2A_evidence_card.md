...
|---|---|
| Symbol | PIK3C2A |
| Approved Name | phosphatidylinositol-4-phosphate 3-kinase catalytic subunit type 2 alpha |
| Target ID | ENSG00000011405 |
| Biotype | protein_coding |
| Association Score | 0.3325 |
| Gap Score | 0.0013 |
| Conservative Gap Score | 0.0017 |
| Gap Rank | 482 |
...
**Lower evidence signal** (association score: 0.3325)
