...
|---|---|
| Symbol | CCDC88A |
| Approved Name | coiled-coil and HOOK domain protein 88A |
| Target ID | ENSG00000115355 |
| Biotype | protein_coding |
| Association Score | 0.3649 |
| Gap Score | 0.0254 |
| Conservative Gap Score | 0.0317 |
| Gap Rank | 372 |
...
**Lower evidence signal** (association score: 0.3649)
