...
|---|---|
| Symbol | ATP8B4 |
| Approved Name | ATPase phospholipid transporting 8B4 (putative) |
| Target ID | ENSG00000104043 |
| Biotype | protein_coding |
| Association Score | 0.4339 |
| Gap Score | 0.0766 |
| Conservative Gap Score | 0.0957 |
| Gap Rank | 211 |
...
**Lower evidence signal** (association score: 0.4339)
