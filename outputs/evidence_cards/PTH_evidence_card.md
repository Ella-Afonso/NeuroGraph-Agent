...
|---|---|
| Symbol | PTH |
| Approved Name | parathyroid hormone |
| Target ID | ENSG00000152266 |
| Biotype | protein_coding |
| Association Score | 0.3463 |
| Gap Score | 0.0116 |
| Conservative Gap Score | 0.0145 |
| Gap Rank | 431 |
...
**Lower evidence signal** (association score: 0.3463)
...
- Symbol 'PTH' has a moderate ambiguity flag — mention counts are especially uncertain.
