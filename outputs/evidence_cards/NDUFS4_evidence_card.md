...
|---|---|
| Symbol | NDUFS4 |
| Approved Name | NADH:ubiquinone oxidoreductase subunit S4 |
| Target ID | ENSG00000164258 |
| Biotype | protein_coding |
| Association Score | 0.3455 |
| Gap Score | 0.0110 |
| Conservative Gap Score | 0.0138 |
| Gap Rank | 435 |
...
**Lower evidence signal** (association score: 0.3455)
