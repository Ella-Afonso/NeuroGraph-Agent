...
|---|---|
| Symbol | ATP6V1C1 |
| Approved Name | ATPase H+ transporting V1 subunit C1 |
| Target ID | ENSG00000155097 |
| Biotype | protein_coding |
| Association Score | 0.5029 |
| Gap Score | 0.1278 |
| Conservative Gap Score | 0.1598 |
| Gap Rank | 93 |
...
**Moderate evidence signal** (association score: 0.5029)
