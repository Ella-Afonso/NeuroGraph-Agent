...
|---|---|
| Symbol | SCD |
| Approved Name | stearoyl-CoA desaturase |
| Target ID | ENSG00000099194 |
| Biotype | protein_coding |
| Association Score | 0.4806 |
| Gap Score | 0.3126 |
| Conservative Gap Score | 0.2948 |
| Gap Rank | 12 |
...
**Lower evidence signal** (association score: 0.4806)
...
In this retrieved literature corpus, the target symbol was detected 6 time(s) across 2 document(s).
...
In this retrieved trial corpus, the target symbol was detected 9 time(s) across 5 registration(s).
...
SCD appears well represented in both literature and trial text in this corpus. It should be treated as an established or trial-covered comparator rather than a gap candidate. It may serve as a reference point for comparing less-studied targets. Note: the symbol 'SCD' may be ambiguous in biomedical or general text; mention counts require manual validation to exclude false positives.
...
- Symbol 'SCD' has a moderate ambiguity flag — mention counts are especially uncertain.
