...
|---|---|
| Symbol | MT-ND1 |
| Approved Name | mitochondrially encoded NADH:ubiquinone oxidoreductase core subunit 1 |
| Target ID | ENSG00000198888 |
| Biotype | protein_coding |
| Association Score | 0.4575 |
| Gap Score | 0.0941 |
| Conservative Gap Score | 0.1176 |
| Gap Rank | 177 |
...
**Lower evidence signal** (association score: 0.4575)
