...
|---|---|
| Symbol | ADRA1D |
| Approved Name | adrenoceptor alpha 1D |
| Target ID | ENSG00000171873 |
| Biotype | protein_coding |
| Association Score | 0.4096 |
| Gap Score | 0.0585 |
| Conservative Gap Score | 0.0732 |
| Gap Rank | 241 |
...
**Lower evidence signal** (association score: 0.4096)
