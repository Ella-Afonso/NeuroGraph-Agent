...
|---|---|
| Symbol | PTGFR |
| Approved Name | prostaglandin F receptor |
| Target ID | ENSG00000122420 |
| Biotype | protein_coding |
| Association Score | 0.3310 |
| Gap Score | 0.0003 |
| Conservative Gap Score | 0.0003 |
| Gap Rank | 496 |
...
**Lower evidence signal** (association score: 0.3310)
