...
|---|---|
| Symbol | LCMT1 |
| Approved Name | leucine carboxyl methyltransferase 1 |
| Target ID | ENSG00000205629 |
| Biotype | protein_coding |
| Association Score | 0.3399 |
| Gap Score | 0.0068 |
| Conservative Gap Score | 0.0085 |
| Gap Rank | 454 |
...
**Lower evidence signal** (association score: 0.3399)
