...
|---|---|
| Symbol | SPTLC2 |
| Approved Name | serine palmitoyltransferase long chain base subunit 2 |
| Target ID | ENSG00000100596 |
| Biotype | protein_coding |
| Association Score | 0.3764 |
| Gap Score | 0.0340 |
| Conservative Gap Score | 0.0424 |
| Gap Rank | 305 |
...
**Lower evidence signal** (association score: 0.3764)
