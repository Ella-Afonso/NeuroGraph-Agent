...
|---|---|
| Symbol | MGAT1 |
| Approved Name | alpha-1,3-mannosyl-glycoprotein 2-beta-N-acetylglucosaminyltransferase |
| Target ID | ENSG00000131446 |
| Biotype | protein_coding |
| Association Score | 0.3502 |
| Gap Score | 0.0145 |
| Conservative Gap Score | 0.0181 |
| Gap Rank | 416 |
...
**Lower evidence signal** (association score: 0.3502)
