...
|---|---|
| Symbol | PVR |
| Approved Name | PVR cell adhesion molecule |
| Target ID | ENSG00000073008 |
| Biotype | protein_coding |
| Association Score | 0.3597 |
| Gap Score | 0.0215 |
| Conservative Gap Score | 0.0269 |
| Gap Rank | 390 |
...
**Lower evidence signal** (association score: 0.3597)
...
- Symbol 'PVR' has a moderate ambiguity flag — mention counts are especially uncertain.
