...
|---|---|
| Symbol | KIT |
| Approved Name | KIT proto-oncogene, receptor tyrosine kinase |
| Target ID | ENSG00000157404 |
| Biotype | protein_coding |
| Association Score | 0.3715 |
| Gap Score | 0.0303 |
| Conservative Gap Score | 0.0379 |
| Gap Rank | 338 |
...
**Lower evidence signal** (association score: 0.3715)
...
- Symbol 'KIT' has a moderate ambiguity flag — mention counts are especially uncertain.
