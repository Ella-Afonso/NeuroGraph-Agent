...
|---|---|
| Symbol | CDC5L |
| Approved Name | cell division cycle 5 like |
| Target ID | ENSG00000096401 |
| Biotype | protein_coding |
| Association Score | 0.3709 |
| Gap Score | 0.0298 |
| Conservative Gap Score | 0.0373 |
| Gap Rank | 343 |
...
**Lower evidence signal** (association score: 0.3709)
