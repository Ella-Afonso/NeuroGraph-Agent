...
|---|---|
| Symbol | RAB9A |
| Approved Name | RAB9A, member RAS oncogene family |
| Target ID | ENSG00000123595 |
| Biotype | protein_coding |
| Association Score | 0.3507 |
| Gap Score | 0.0149 |
| Conservative Gap Score | 0.0186 |
| Gap Rank | 415 |
...
**Lower evidence signal** (association score: 0.3507)
