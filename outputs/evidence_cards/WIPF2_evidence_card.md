...
|---|---|
| Symbol | WIPF2 |
| Approved Name | WAS/WASL interacting protein family member 2 |
| Target ID | ENSG00000171475 |
| Biotype | protein_coding |
| Association Score | 0.3516 |
| Gap Score | 0.0156 |
| Conservative Gap Score | 0.0195 |
| Gap Rank | 413 |
...
**Lower evidence signal** (association score: 0.3516)
