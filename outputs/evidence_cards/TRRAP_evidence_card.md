...
|---|---|
| Symbol | TRRAP |
| Approved Name | transformation/transcription domain associated protein |
| Target ID | ENSG00000196367 |
| Biotype | protein_coding |
| Association Score | 0.3554 |
| Gap Score | 0.0183 |
| Conservative Gap Score | 0.0229 |
| Gap Rank | 402 |
...
**Lower evidence signal** (association score: 0.3554)
