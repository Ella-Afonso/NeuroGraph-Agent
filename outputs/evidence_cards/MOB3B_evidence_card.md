...
|---|---|
| Symbol | MOB3B |
| Approved Name | MOB kinase activator 3B |
| Target ID | ENSG00000120162 |
| Biotype | protein_coding |
| Association Score | 0.4043 |
| Gap Score | 0.0546 |
| Conservative Gap Score | 0.0683 |
| Gap Rank | 245 |
...
**Lower evidence signal** (association score: 0.4043)
