...
|---|---|
| Symbol | HTR1B |
| Approved Name | 5-hydroxytryptamine receptor 1B |
| Target ID | ENSG00000135312 |
| Biotype | protein_coding |
| Association Score | 0.3759 |
| Gap Score | 0.0335 |
| Conservative Gap Score | 0.0419 |
| Gap Rank | 310 |
...
**Lower evidence signal** (association score: 0.3759)
