...
|---|---|
| Symbol | SBF1 |
| Approved Name | SET binding factor 1 |
| Target ID | ENSG00000100241 |
| Biotype | protein_coding |
| Association Score | 0.4519 |
| Gap Score | 0.0900 |
| Conservative Gap Score | 0.1125 |
| Gap Rank | 186 |
...
**Lower evidence signal** (association score: 0.4519)
