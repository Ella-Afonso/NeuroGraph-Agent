...
|---|---|
| Symbol | AP2M1 |
| Approved Name | adaptor related protein complex 2 subunit mu 1 |
| Target ID | ENSG00000161203 |
| Biotype | protein_coding |
| Association Score | 0.4682 |
| Gap Score | 0.1021 |
| Conservative Gap Score | 0.1276 |
| Gap Rank | 131 |
...
**Lower evidence signal** (association score: 0.4682)
