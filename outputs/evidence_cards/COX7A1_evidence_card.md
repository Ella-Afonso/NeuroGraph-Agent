...
|---|---|
| Symbol | COX7A1 |
| Approved Name | cytochrome c oxidase subunit 7A1 |
| Target ID | ENSG00000161281 |
| Biotype | protein_coding |
| Association Score | 0.3416 |
| Gap Score | 0.0081 |
| Conservative Gap Score | 0.0102 |
| Gap Rank | 448 |
...
**Lower evidence signal** (association score: 0.3416)
