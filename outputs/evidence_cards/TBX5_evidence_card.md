...
|---|---|
| Symbol | TBX5 |
| Approved Name | T-box transcription factor 5 |
| Target ID | ENSG00000089225 |
| Biotype | protein_coding |
| Association Score | 0.3376 |
| Gap Score | 0.0051 |
| Conservative Gap Score | 0.0064 |
| Gap Rank | 464 |
...
**Lower evidence signal** (association score: 0.3376)
