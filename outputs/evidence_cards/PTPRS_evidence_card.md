...
|---|---|
| Symbol | PTPRS |
| Approved Name | protein tyrosine phosphatase receptor type S |
| Target ID | ENSG00000105426 |
| Biotype | protein_coding |
| Association Score | 0.3704 |
| Gap Score | 0.0295 |
| Conservative Gap Score | 0.0368 |
| Gap Rank | 346 |
...
**Lower evidence signal** (association score: 0.3704)
