...
|---|---|
| Symbol | NOC4L |
| Approved Name | nucleolar complex associated 4 homolog |
| Target ID | ENSG00000184967 |
| Biotype | protein_coding |
| Association Score | 0.4791 |
| Gap Score | 0.1102 |
| Conservative Gap Score | 0.1377 |
| Gap Rank | 112 |
...
**Lower evidence signal** (association score: 0.4791)
