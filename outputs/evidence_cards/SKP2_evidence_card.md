...
|---|---|
| Symbol | SKP2 |
| Approved Name | S-phase kinase associated protein 2 |
| Target ID | ENSG00000145604 |
| Biotype | protein_coding |
| Association Score | 0.4376 |
| Gap Score | 0.0793 |
| Conservative Gap Score | 0.0992 |
| Gap Rank | 202 |
...
**Lower evidence signal** (association score: 0.4376)
