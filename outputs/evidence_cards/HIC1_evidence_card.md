...
|---|---|
| Symbol | HIC1 |
| Approved Name | HIC ZBTB transcriptional repressor 1 |
| Target ID | ENSG00000177374 |
| Biotype | protein_coding |
| Association Score | 0.3461 |
| Gap Score | 0.0115 |
| Conservative Gap Score | 0.0144 |
| Gap Rank | 432 |
...
**Lower evidence signal** (association score: 0.3461)
