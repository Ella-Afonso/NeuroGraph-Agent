...
|---|---|
| Symbol | B4GALT2 |
| Approved Name | beta-1,4-galactosyltransferase 2 |
| Target ID | ENSG00000117411 |
| Biotype | protein_coding |
| Association Score | 0.4580 |
| Gap Score | 0.0945 |
| Conservative Gap Score | 0.1181 |
| Gap Rank | 176 |
...
**Lower evidence signal** (association score: 0.4580)
