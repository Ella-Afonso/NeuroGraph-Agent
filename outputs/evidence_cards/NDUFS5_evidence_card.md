...
|---|---|
| Symbol | NDUFS5 |
| Approved Name | NADH:ubiquinone oxidoreductase subunit S5 |
| Target ID | ENSG00000168653 |
| Biotype | protein_coding |
| Association Score | 0.5340 |
| Gap Score | 0.1509 |
| Conservative Gap Score | 0.1886 |
| Gap Rank | 59 |
...
**Moderate evidence signal** (association score: 0.5340)
