...
|---|---|
| Symbol | RRP15 |
| Approved Name | ribosomal RNA processing 15 homolog |
| Target ID | ENSG00000067533 |
| Biotype | protein_coding |
| Association Score | 0.4727 |
| Gap Score | 0.1054 |
| Conservative Gap Score | 0.1318 |
| Gap Rank | 123 |
...
**Lower evidence signal** (association score: 0.4727)
