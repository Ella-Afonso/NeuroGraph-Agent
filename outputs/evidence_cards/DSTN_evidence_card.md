...
|---|---|
| Symbol | DSTN |
| Approved Name | destrin, actin depolymerizing factor |
| Target ID | ENSG00000125868 |
| Biotype | protein_coding |
| Association Score | 0.3313 |
| Gap Score | 0.0005 |
| Conservative Gap Score | 0.0006 |
| Gap Rank | 494 |
...
**Lower evidence signal** (association score: 0.3313)
