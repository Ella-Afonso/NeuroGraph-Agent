...
|---|---|
| Symbol | HINFP |
| Approved Name | histone H4 transcription factor |
| Target ID | ENSG00000172273 |
| Biotype | protein_coding |
| Association Score | 0.3727 |
| Gap Score | 0.0312 |
| Conservative Gap Score | 0.0390 |
| Gap Rank | 323 |
...
**Lower evidence signal** (association score: 0.3727)
