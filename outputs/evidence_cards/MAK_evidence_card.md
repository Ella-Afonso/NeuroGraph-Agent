...
|---|---|
| Symbol | MAK |
| Approved Name | male germ cell associated kinase |
| Target ID | ENSG00000111837 |
| Biotype | protein_coding |
| Association Score | 0.4030 |
| Gap Score | 0.0537 |
| Conservative Gap Score | 0.0671 |
| Gap Rank | 248 |
...
**Lower evidence signal** (association score: 0.4030)
...
- Symbol 'MAK' has a moderate ambiguity flag — mention counts are especially uncertain.
