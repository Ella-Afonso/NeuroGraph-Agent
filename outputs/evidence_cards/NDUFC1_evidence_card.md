...
|---|---|
| Symbol | NDUFC1 |
| Approved Name | NADH:ubiquinone oxidoreductase subunit C1 |
| Target ID | ENSG00000109390 |
| Biotype | protein_coding |
| Association Score | 0.4494 |
| Gap Score | 0.0881 |
| Conservative Gap Score | 0.1102 |
| Gap Rank | 190 |
...
**Lower evidence signal** (association score: 0.4494)
