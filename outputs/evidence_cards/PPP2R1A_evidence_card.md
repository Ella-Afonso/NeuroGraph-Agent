...
|---|---|
| Symbol | PPP2R1A |
| Approved Name | protein phosphatase 2 scaffold subunit Aalpha |
| Target ID | ENSG00000105568 |
| Biotype | protein_coding |
| Association Score | 0.3692 |
| Gap Score | 0.0286 |
| Conservative Gap Score | 0.0358 |
| Gap Rank | 361 |
...
**Lower evidence signal** (association score: 0.3692)
