...
|---|---|
| Symbol | MRPS27 |
| Approved Name | mitochondrial ribosomal protein S27 |
| Target ID | ENSG00000113048 |
| Biotype | protein_coding |
| Association Score | 0.3990 |
| Gap Score | 0.0507 |
| Conservative Gap Score | 0.0634 |
| Gap Rank | 256 |
...
**Lower evidence signal** (association score: 0.3990)
