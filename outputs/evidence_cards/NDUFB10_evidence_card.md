...
|---|---|
| Symbol | NDUFB10 |
| Approved Name | NADH:ubiquinone oxidoreductase subunit B10 |
| Target ID | ENSG00000140990 |
| Biotype | protein_coding |
| Association Score | 0.3699 |
| Gap Score | 0.0292 |
| Conservative Gap Score | 0.0364 |
| Gap Rank | 349 |
...
**Lower evidence signal** (association score: 0.3699)
