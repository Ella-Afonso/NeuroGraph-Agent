...
|---|---|
| Symbol | TSPO |
| Approved Name | translocator protein |
| Target ID | ENSG00000100300 |
| Biotype | protein_coding |
| Association Score | 0.3956 |
| Gap Score | 0.0482 |
| Conservative Gap Score | 0.0602 |
| Gap Rank | 260 |
...
**Lower evidence signal** (association score: 0.3956)
...
TSPO appears well represented in both literature and trial text in this corpus. It should be treated as an established or trial-covered comparator rather than a gap candidate. It may serve as a reference point for comparing less-studied targets.
