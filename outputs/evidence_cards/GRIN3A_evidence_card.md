...
|---|---|
| Symbol | GRIN3A |
| Approved Name | glutamate ionotropic receptor NMDA type subunit 3A |
| Target ID | ENSG00000198785 |
| Biotype | protein_coding |
| Association Score | 0.6101 |
| Gap Score | 0.2074 |
| Conservative Gap Score | 0.2592 |
| Gap Rank | 29 |
...
**Moderate evidence signal** (association score: 0.6101)
