...
|---|---|
| Symbol | CREB1 |
| Approved Name | cAMP responsive element binding protein 1 |
| Target ID | ENSG00000118260 |
| Biotype | protein_coding |
| Association Score | 0.3979 |
| Gap Score | 0.0499 |
| Conservative Gap Score | 0.0624 |
| Gap Rank | 257 |
...
**Lower evidence signal** (association score: 0.3979)
