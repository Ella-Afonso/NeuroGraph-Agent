...
|---|---|
| Symbol | GRIA1 |
| Approved Name | glutamate ionotropic receptor AMPA type subunit 1 |
| Target ID | ENSG00000155511 |
| Biotype | protein_coding |
| Association Score | 0.3354 |
| Gap Score | 0.0035 |
| Conservative Gap Score | 0.0044 |
| Gap Rank | 473 |
...
**Lower evidence signal** (association score: 0.3354)
