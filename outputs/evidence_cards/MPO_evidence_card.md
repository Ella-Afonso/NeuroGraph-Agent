...
| Target ID | ENSG00000005381 |
| Biotype | protein_coding |
| Association Score | 0.5118 |
| Gap Score | 0.1344 |
| Conservative Gap Score | 0.1680 |
| Gap Rank | 81 |
...
**Moderate evidence signal** (association score: 0.5118)
...
- Symbol 'MPO' has a moderate ambiguity flag — mention counts are especially uncertain.
