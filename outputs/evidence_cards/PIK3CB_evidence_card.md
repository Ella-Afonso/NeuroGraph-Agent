...
|---|---|
| Symbol | PIK3CB |
| Approved Name | phosphatidylinositol-4,5-bisphosphate 3-kinase catalytic subunit beta |
| Target ID | ENSG00000051382 |
| Biotype | protein_coding |
| Association Score | 0.4869 |
| Gap Score | 0.1159 |
| Conservative Gap Score | 0.1449 |
| Gap Rank | 106 |
...
**Lower evidence signal** (association score: 0.4869)
