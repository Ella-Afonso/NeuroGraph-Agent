...
|---|---|
| Symbol | H2BC4 |
| Approved Name | H2B clustered histone 4 |
| Target ID | ENSG00000180596 |
| Biotype | protein_coding |
| Association Score | 0.4953 |
| Gap Score | 0.1222 |
| Conservative Gap Score | 0.1527 |
| Gap Rank | 101 |
...
**Lower evidence signal** (association score: 0.4953)
