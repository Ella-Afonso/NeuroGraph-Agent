...
|---|---|
| Symbol | PILRA |
| Approved Name | paired immunoglobin like type 2 receptor alpha |
| Target ID | ENSG00000085514 |
| Biotype | protein_coding |
| Association Score | 0.4464 |
| Gap Score | 0.0859 |
| Conservative Gap Score | 0.1074 |
| Gap Rank | 196 |
...
**Lower evidence signal** (association score: 0.4464)
