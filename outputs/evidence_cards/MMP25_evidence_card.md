...
|---|---|
| Symbol | MMP25 |
| Approved Name | matrix metallopeptidase 25 |
| Target ID | ENSG00000008516 |
| Biotype | protein_coding |
| Association Score | 0.4083 |
| Gap Score | 0.0576 |
| Conservative Gap Score | 0.0720 |
| Gap Rank | 243 |
...
**Lower evidence signal** (association score: 0.4083)
