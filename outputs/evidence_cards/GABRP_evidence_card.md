...
|---|---|
| Symbol | GABRP |
| Approved Name | gamma-aminobutyric acid type A receptor subunit pi |
| Target ID | ENSG00000094755 |
| Biotype | protein_coding |
| Association Score | 0.4814 |
| Gap Score | 0.1119 |
| Conservative Gap Score | 0.1398 |
| Gap Rank | 110 |
...
**Lower evidence signal** (association score: 0.4814)
