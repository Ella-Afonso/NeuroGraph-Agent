...
|---|---|
| Symbol | AASS |
| Approved Name | aminoadipate-semialdehyde synthase |
| Target ID | ENSG00000008311 |
| Biotype | protein_coding |
| Association Score | 0.3335 |
| Gap Score | 0.0021 |
| Conservative Gap Score | 0.0026 |
| Gap Rank | 478 |
...
**Lower evidence signal** (association score: 0.3335)
