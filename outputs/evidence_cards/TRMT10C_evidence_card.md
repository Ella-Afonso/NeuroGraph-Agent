...
|---|---|
| Symbol | TRMT10C |
| Approved Name | tRNA methyltransferase 10C, mitochondrial RNase P subunit |
| Target ID | ENSG00000174173 |
| Biotype | protein_coding |
| Association Score | 0.3497 |
| Gap Score | 0.0141 |
| Conservative Gap Score | 0.0177 |
| Gap Rank | 417 |
...
**Lower evidence signal** (association score: 0.3497)
