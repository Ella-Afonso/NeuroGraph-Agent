...
|---|---|
| Symbol | FASTK |
| Approved Name | Fas activated serine/threonine kinase |
| Target ID | ENSG00000164896 |
| Biotype | protein_coding |
| Association Score | 0.3729 |
| Gap Score | 0.0313 |
| Conservative Gap Score | 0.0392 |
| Gap Rank | 321 |
...
**Lower evidence signal** (association score: 0.3729)
