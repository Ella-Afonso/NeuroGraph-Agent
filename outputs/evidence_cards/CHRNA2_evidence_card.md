...
|---|---|
| Symbol | CHRNA2 |
| Approved Name | cholinergic receptor nicotinic alpha 2 subunit |
| Target ID | ENSG00000120903 |
| Biotype | protein_coding |
| Association Score | 0.3309 |
| Gap Score | 0.0002 |
| Conservative Gap Score | 0.0002 |
| Gap Rank | 497 |
...
**Lower evidence signal** (association score: 0.3309)
