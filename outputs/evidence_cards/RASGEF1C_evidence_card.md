...
|---|---|
| Symbol | RASGEF1C |
| Approved Name | RasGEF domain family member 1C |
| Target ID | ENSG00000146090 |
| Biotype | protein_coding |
| Association Score | 0.4704 |
| Gap Score | 0.1037 |
| Conservative Gap Score | 0.1296 |
| Gap Rank | 124 |
...
**Lower evidence signal** (association score: 0.4704)
