...
|---|---|
| Symbol | PAPOLA |
| Approved Name | poly(A) polymerase alpha |
| Target ID | ENSG00000090060 |
| Biotype | protein_coding |
| Association Score | 0.4268 |
| Gap Score | 0.0714 |
| Conservative Gap Score | 0.0892 |
| Gap Rank | 216 |
...
**Lower evidence signal** (association score: 0.4268)
