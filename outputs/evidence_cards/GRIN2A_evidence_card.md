...
|---|---|
| Symbol | GRIN2A |
| Approved Name | glutamate ionotropic receptor NMDA type subunit 2A |
| Target ID | ENSG00000183454 |
| Biotype | protein_coding |
| Association Score | 0.6152 |
| Gap Score | 0.2111 |
| Conservative Gap Score | 0.2639 |
| Gap Rank | 27 |
...
**Moderate evidence signal** (association score: 0.6152)
