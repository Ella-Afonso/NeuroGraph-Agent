...
|---|---|
| Symbol | JUN |
| Approved Name | Jun proto-oncogene, AP-1 transcription factor subunit |
| Target ID | ENSG00000177606 |
| Biotype | protein_coding |
| Association Score | 0.3884 |
| Gap Score | 0.0428 |
| Conservative Gap Score | 0.0535 |
| Gap Rank | 276 |
...
**Lower evidence signal** (association score: 0.3884)
...
- Symbol 'JUN' has a moderate ambiguity flag — mention counts are especially uncertain.
