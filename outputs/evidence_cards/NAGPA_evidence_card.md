...
|---|---|
| Symbol | NAGPA |
| Approved Name | N-acetylglucosamine-1-phosphodiester alpha-N-acetylglucosaminidase |
| Target ID | ENSG00000103174 |
| Biotype | protein_coding |
| Association Score | 0.4639 |
| Gap Score | 0.0989 |
| Conservative Gap Score | 0.1236 |
| Gap Rank | 143 |
...
**Lower evidence signal** (association score: 0.4639)
