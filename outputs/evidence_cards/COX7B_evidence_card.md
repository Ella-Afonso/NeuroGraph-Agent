...
|---|---|
| Symbol | COX7B |
| Approved Name | cytochrome c oxidase subunit 7B |
| Target ID | ENSG00000131174 |
| Biotype | protein_coding |
| Association Score | 0.3622 |
| Gap Score | 0.0234 |
| Conservative Gap Score | 0.0292 |
| Gap Rank | 383 |
...
**Lower evidence signal** (association score: 0.3622)
