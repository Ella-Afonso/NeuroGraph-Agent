...
|---|---|
| Symbol | SUPT6H |
| Approved Name | SPT6 homolog, histone chaperone and transcription elongation factor |
| Target ID | ENSG00000109111 |
| Biotype | protein_coding |
| Association Score | 0.4620 |
| Gap Score | 0.0974 |
| Conservative Gap Score | 0.1218 |
| Gap Rank | 170 |
...
**Lower evidence signal** (association score: 0.4620)
