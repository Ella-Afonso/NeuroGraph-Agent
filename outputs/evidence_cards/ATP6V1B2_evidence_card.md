...
|---|---|
| Symbol | ATP6V1B2 |
| Approved Name | ATPase H+ transporting V1 subunit B2 |
| Target ID | ENSG00000147416 |
| Biotype | protein_coding |
| Association Score | 0.5212 |
| Gap Score | 0.1414 |
| Conservative Gap Score | 0.1767 |
| Gap Rank | 74 |
...
**Moderate evidence signal** (association score: 0.5212)
