...
|---|---|
| Symbol | HCN4 |
| Approved Name | hyperpolarization activated cyclic nucleotide gated potassium channel 4 |
| Target ID | ENSG00000138622 |
| Biotype | protein_coding |
| Association Score | 0.3317 |
| Gap Score | 0.0008 |
| Conservative Gap Score | 0.0010 |
| Gap Rank | 489 |
...
**Lower evidence signal** (association score: 0.3317)
