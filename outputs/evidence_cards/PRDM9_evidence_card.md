...
|---|---|
| Symbol | PRDM9 |
| Approved Name | PR/SET domain 9 |
| Target ID | ENSG00000164256 |
| Biotype | protein_coding |
| Association Score | 0.3541 |
| Gap Score | 0.0174 |
| Conservative Gap Score | 0.0217 |
| Gap Rank | 404 |
...
**Lower evidence signal** (association score: 0.3541)
