...
|---|---|
| Symbol | SON |
| Approved Name | SON DNA and RNA binding protein |
| Target ID | ENSG00000159140 |
| Biotype | protein_coding |
| Association Score | 0.4652 |
| Gap Score | 0.0998 |
| Conservative Gap Score | 0.1248 |
| Gap Rank | 135 |
| Gap Category | Moderate gap signal |
| Gap Interpretation Tier | Checked-zero text signal |
| Symbol Ambiguity Flag | moderate |

## 2. Evidence Strength

**Lower evidence signal** (association score: 0.4652)
...
- Symbol 'SON' has a moderate ambiguity flag — mention counts are especially uncertain.
