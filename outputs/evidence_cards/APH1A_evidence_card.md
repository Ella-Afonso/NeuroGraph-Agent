...
|---|---|
| Symbol | APH1A |
| Approved Name | aph-1A gamma-secretase subunit |
| Target ID | ENSG00000117362 |
| Biotype | protein_coding |
| Association Score | 0.4001 |
| Gap Score | 0.0516 |
| Conservative Gap Score | 0.0644 |
| Gap Rank | 253 |
...
**Lower evidence signal** (association score: 0.4001)
