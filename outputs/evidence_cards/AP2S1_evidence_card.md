...
|---|---|
| Symbol | AP2S1 |
| Approved Name | adaptor related protein complex 2 subunit sigma 1 |
| Target ID | ENSG00000042753 |
| Biotype | protein_coding |
| Association Score | 0.4774 |
| Gap Score | 0.1089 |
| Conservative Gap Score | 0.1361 |
| Gap Rank | 114 |
...
**Lower evidence signal** (association score: 0.4774)
