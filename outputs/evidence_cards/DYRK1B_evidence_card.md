...
|---|---|
| Symbol | DYRK1B |
| Approved Name | dual specificity tyrosine phosphorylation regulated kinase 1B |
| Target ID | ENSG00000105204 |
| Biotype | protein_coding |
| Association Score | 0.3318 |
| Gap Score | 0.0008 |
| Conservative Gap Score | 0.0011 |
| Gap Rank | 488 |
...
**Lower evidence signal** (association score: 0.3318)
