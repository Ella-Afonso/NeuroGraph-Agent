...
|---|---|
| Symbol | PTPRO |
| Approved Name | protein tyrosine phosphatase receptor type O |
| Target ID | ENSG00000151490 |
| Biotype | protein_coding |
| Association Score | 0.3730 |
| Gap Score | 0.0314 |
| Conservative Gap Score | 0.0393 |
| Gap Rank | 317 |
...
**Lower evidence signal** (association score: 0.3730)
