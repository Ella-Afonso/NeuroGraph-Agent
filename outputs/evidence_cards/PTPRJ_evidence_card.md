...
|---|---|
| Symbol | PTPRJ |
| Approved Name | protein tyrosine phosphatase receptor type J |
| Target ID | ENSG00000149177 |
| Biotype | protein_coding |
| Association Score | 0.3732 |
| Gap Score | 0.0315 |
| Conservative Gap Score | 0.0394 |
| Gap Rank | 316 |
...
**Lower evidence signal** (association score: 0.3732)
