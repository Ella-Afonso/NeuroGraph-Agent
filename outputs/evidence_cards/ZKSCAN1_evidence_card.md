...
|---|---|
| Symbol | ZKSCAN1 |
| Approved Name | zinc finger with KRAB and SCAN domains 1 |
| Target ID | ENSG00000106261 |
| Biotype | protein_coding |
| Association Score | 0.3828 |
| Gap Score | 0.0387 |
| Conservative Gap Score | 0.0484 |
| Gap Rank | 291 |
...
**Lower evidence signal** (association score: 0.3828)
