...
|---|---|
| Symbol | ATP1A1 |
| Approved Name | ATPase Na+/K+ transporting subunit alpha 1 |
| Target ID | ENSG00000163399 |
| Biotype | protein_coding |
| Association Score | 0.4512 |
| Gap Score | 0.0895 |
| Conservative Gap Score | 0.1118 |
| Gap Rank | 187 |
...
**Lower evidence signal** (association score: 0.4512)
