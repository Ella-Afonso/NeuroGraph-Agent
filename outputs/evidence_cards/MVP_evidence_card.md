...
|---|---|
| Symbol | MVP |
| Approved Name | major vault protein |
| Target ID | ENSG00000013364 |
| Biotype | protein_coding |
| Association Score | 0.3430 |
| Gap Score | 0.0092 |
| Conservative Gap Score | 0.0115 |
| Gap Rank | 443 |
...
**Lower evidence signal** (association score: 0.3430)
...
- Symbol 'MVP' has a moderate ambiguity flag — mention counts are especially uncertain.
