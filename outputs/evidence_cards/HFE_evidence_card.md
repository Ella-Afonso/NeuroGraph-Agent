...
|---|---|
| Symbol | HFE |
| Approved Name | homeostatic iron regulator |
| Target ID | ENSG00000010704 |
| Biotype | protein_coding |
| Association Score | 0.6049 |
| Gap Score | 0.2035 |
| Conservative Gap Score | 0.2544 |
| Gap Rank | 34 |
...
**Moderate evidence signal** (association score: 0.6049)
...
- Symbol 'HFE' has a moderate ambiguity flag — mention counts are especially uncertain.
