...
|---|---|
| Symbol | PIM1 |
| Approved Name | Pim-1 proto-oncogene, serine/threonine kinase |
| Target ID | ENSG00000137193 |
| Biotype | protein_coding |
| Association Score | 0.3326 |
| Gap Score | 0.0014 |
| Conservative Gap Score | 0.0018 |
| Gap Rank | 480 |
...
**Lower evidence signal** (association score: 0.3326)
