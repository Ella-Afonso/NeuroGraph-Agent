...
|---|---|
| Symbol | NDUFC2 |
| Approved Name | NADH:ubiquinone oxidoreductase subunit C2 |
| Target ID | ENSG00000151366 |
| Biotype | protein_coding |
| Association Score | 0.4670 |
| Gap Score | 0.1012 |
| Conservative Gap Score | 0.1265 |
| Gap Rank | 133 |
...
**Lower evidence signal** (association score: 0.4670)
