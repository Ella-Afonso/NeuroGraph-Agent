...
|---|---|
| Symbol | TRAPPC5 |
| Approved Name | trafficking protein particle complex subunit 5 |
| Target ID | ENSG00000181029 |
| Biotype | protein_coding |
| Association Score | 0.4348 |
| Gap Score | 0.0772 |
| Conservative Gap Score | 0.0966 |
| Gap Rank | 208 |
...
**Lower evidence signal** (association score: 0.4348)
