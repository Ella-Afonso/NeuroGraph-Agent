...
|---|---|
| Symbol | BMS1 |
| Approved Name | BMS1 ribosome biogenesis factor |
| Target ID | ENSG00000165733 |
| Biotype | protein_coding |
| Association Score | 0.4825 |
| Gap Score | 0.1127 |
| Conservative Gap Score | 0.1408 |
| Gap Rank | 108 |
...
**Lower evidence signal** (association score: 0.4825)
