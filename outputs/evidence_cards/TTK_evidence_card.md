...
|---|---|
| Symbol | TTK |
| Approved Name | TTK protein kinase |
| Target ID | ENSG00000112742 |
| Biotype | protein_coding |
| Association Score | 0.3779 |
| Gap Score | 0.0351 |
| Conservative Gap Score | 0.0438 |
| Gap Rank | 301 |
...
**Lower evidence signal** (association score: 0.3779)
...
- Symbol 'TTK' has a moderate ambiguity flag — mention counts are especially uncertain.
