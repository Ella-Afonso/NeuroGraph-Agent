...
|---|---|
| Symbol | CCN3 |
| Approved Name | cellular communication network factor 3 |
| Target ID | ENSG00000136999 |
| Biotype | protein_coding |
| Association Score | 0.3383 |
| Gap Score | 0.0057 |
| Conservative Gap Score | 0.0071 |
| Gap Rank | 461 |
...
**Lower evidence signal** (association score: 0.3383)
