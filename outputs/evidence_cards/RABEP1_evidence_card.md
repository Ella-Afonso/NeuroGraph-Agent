...
|---|---|
| Symbol | RABEP1 |
| Approved Name | rabaptin, RAB GTPase binding effector protein 1 |
| Target ID | ENSG00000029725 |
| Biotype | protein_coding |
| Association Score | 0.3307 |
| Gap Score | 0.0000 |
| Conservative Gap Score | 0.0000 |
| Gap Rank | 499 |
...
**Lower evidence signal** (association score: 0.3307)
