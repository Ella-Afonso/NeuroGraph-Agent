...
|---|---|
| Symbol | MCM10 |
| Approved Name | minichromosome maintenance 10 replication initiation factor |
| Target ID | ENSG00000065328 |
| Biotype | protein_coding |
| Association Score | 0.4634 |
| Gap Score | 0.0985 |
| Conservative Gap Score | 0.1231 |
| Gap Rank | 147 |
...
**Lower evidence signal** (association score: 0.4634)
