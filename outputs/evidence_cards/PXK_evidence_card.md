...
|---|---|
| Symbol | PXK |
| Approved Name | PX domain containing serine/threonine kinase like |
| Target ID | ENSG00000168297 |
| Biotype | protein_coding |
| Association Score | 0.4626 |
| Gap Score | 0.0979 |
| Conservative Gap Score | 0.1224 |
| Gap Rank | 161 |
...
**Lower evidence signal** (association score: 0.4626)
...
- Symbol 'PXK' has a moderate ambiguity flag — mention counts are especially uncertain.
