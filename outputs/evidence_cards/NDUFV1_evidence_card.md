...
|---|---|
| Symbol | NDUFV1 |
| Approved Name | NADH:ubiquinone oxidoreductase core subunit V1 |
| Target ID | ENSG00000167792 |
| Biotype | protein_coding |
| Association Score | 0.4478 |
| Gap Score | 0.0869 |
| Conservative Gap Score | 0.1087 |
| Gap Rank | 194 |
...
**Lower evidence signal** (association score: 0.4478)
