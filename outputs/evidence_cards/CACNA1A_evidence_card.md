...
|---|---|
| Symbol | CACNA1A |
| Approved Name | calcium voltage-gated channel subunit alpha1 A |
| Target ID | ENSG00000141837 |
| Biotype | protein_coding |
| Association Score | 0.3539 |
| Gap Score | 0.0173 |
| Conservative Gap Score | 0.0216 |
| Gap Rank | 405 |
...
**Lower evidence signal** (association score: 0.3539)
