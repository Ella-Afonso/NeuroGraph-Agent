...
|---|---|
| Symbol | GRN |
| Approved Name | granulin precursor |
| Target ID | ENSG00000030582 |
| Biotype | protein_coding |
| Association Score | 0.5811 |
| Gap Score | 0.1858 |
| Conservative Gap Score | 0.2323 |
| Gap Rank | 42 |
...
**Moderate evidence signal** (association score: 0.5811)
...
- Symbol 'GRN' has a moderate ambiguity flag — mention counts are especially uncertain.
