...
|---|---|
| Symbol | NDUFB4 |
| Approved Name | NADH:ubiquinone oxidoreductase subunit B4 |
| Target ID | ENSG00000065518 |
| Biotype | protein_coding |
| Association Score | 0.4398 |
| Gap Score | 0.0810 |
| Conservative Gap Score | 0.1013 |
| Gap Rank | 201 |
...
**Lower evidence signal** (association score: 0.4398)
