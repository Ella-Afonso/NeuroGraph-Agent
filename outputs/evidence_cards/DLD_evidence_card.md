...
|---|---|
| Symbol | DLD |
| Approved Name | dihydrolipoamide dehydrogenase |
| Target ID | ENSG00000091140 |
| Biotype | protein_coding |
| Association Score | 0.4023 |
| Gap Score | 0.0532 |
| Conservative Gap Score | 0.0665 |
| Gap Rank | 250 |
...
**Lower evidence signal** (association score: 0.4023)
...
- Symbol 'DLD' has a moderate ambiguity flag — mention counts are especially uncertain.
