...
|---|---|
| Symbol | PIP5K1A |
| Approved Name | phosphatidylinositol-4-phosphate 5-kinase type 1 alpha |
| Target ID | ENSG00000143398 |
| Biotype | protein_coding |
| Association Score | 0.4139 |
| Gap Score | 0.0617 |
| Conservative Gap Score | 0.0772 |
| Gap Rank | 233 |
...
**Lower evidence signal** (association score: 0.4139)
