...
|---|---|
| Symbol | CCDC6 |
| Approved Name | coiled-coil domain containing 6 |
| Target ID | ENSG00000108091 |
| Biotype | protein_coding |
| Association Score | 0.3535 |
| Gap Score | 0.0169 |
| Conservative Gap Score | 0.0211 |
| Gap Rank | 409 |
...
**Lower evidence signal** (association score: 0.3535)
