...
|---|---|
| Symbol | CDKN2B |
| Approved Name | cyclin dependent kinase inhibitor 2B |
| Target ID | ENSG00000147883 |
| Biotype | protein_coding |
| Association Score | 0.5531 |
| Gap Score | 0.1651 |
| Conservative Gap Score | 0.2064 |
| Gap Rank | 50 |
...
**Moderate evidence signal** (association score: 0.5531)
