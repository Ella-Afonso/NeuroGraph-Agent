...
|---|---|
| Symbol | GABRB1 |
| Approved Name | gamma-aminobutyric acid type A receptor subunit beta1 |
| Target ID | ENSG00000163288 |
| Biotype | protein_coding |
| Association Score | 0.3951 |
| Gap Score | 0.0478 |
| Conservative Gap Score | 0.0598 |
| Gap Rank | 262 |
...
**Lower evidence signal** (association score: 0.3951)
