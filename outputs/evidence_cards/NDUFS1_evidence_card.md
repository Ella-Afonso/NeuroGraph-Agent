...
|---|---|
| Symbol | NDUFS1 |
| Approved Name | NADH:ubiquinone oxidoreductase core subunit S1 |
| Target ID | ENSG00000023228 |
| Biotype | protein_coding |
| Association Score | 0.5233 |
| Gap Score | 0.1429 |
| Conservative Gap Score | 0.1787 |
| Gap Rank | 72 |
...
**Moderate evidence signal** (association score: 0.5233)
