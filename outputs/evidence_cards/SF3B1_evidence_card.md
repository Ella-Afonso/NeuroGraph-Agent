...
|---|---|
| Symbol | SF3B1 |
| Approved Name | splicing factor 3b subunit 1 |
| Target ID | ENSG00000115524 |
| Biotype | protein_coding |
| Association Score | 0.4644 |
| Gap Score | 0.0993 |
| Conservative Gap Score | 0.1241 |
| Gap Rank | 139 |
...
**Lower evidence signal** (association score: 0.4644)
