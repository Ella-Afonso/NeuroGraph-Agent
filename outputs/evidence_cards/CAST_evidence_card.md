...
|---|---|
| Symbol | CAST |
| Approved Name | calpastatin |
| Target ID | ENSG00000153113 |
| Biotype | lncRNA |
| Association Score | 0.3807 |
| Gap Score | 0.1347 |
| Conservative Gap Score | 0.1278 |
| Gap Rank | 79 |
| Gap Category | Moderate gap signal |
| Gap Interpretation Tier | Low-priority / weak gap signal |
| Symbol Ambiguity Flag | low |

## 2. Evidence Strength

**Lower evidence signal** (association score: 0.3807)
...
**Dominant literature themes:** Drug/Therapeutic Interventions
...
CAST shows weak evidence and literature signals in this corpus. It may represent a lower-priority target relative to others in this dataset, but this assessment is limited to the retrieved corpus sample.
...
| --- | --- | --- | --- | --- |
| Amyloid β-based therapy for Alzheimer’s disease: challenges, successes and futu… | 2023 | 729 | Signal Transduction and Targeted Therapy | Drug/Therapeutic Interventions |
