...
|---|---|
| Symbol | PDE4B |
| Approved Name | phosphodiesterase 4B |
| Target ID | ENSG00000184588 |
| Biotype | protein_coding |
| Association Score | 0.4031 |
| Gap Score | 0.0537 |
| Conservative Gap Score | 0.0672 |
| Gap Rank | 247 |
...
**Lower evidence signal** (association score: 0.4031)
...
In this retrieved trial corpus, the target symbol was detected 2 time(s) across 1 registration(s).
...
PDE4B appears well represented in both literature and trial text in this corpus. It should be treated as an established or trial-covered comparator rather than a gap candidate. It may serve as a reference point for comparing less-studied targets.
