...
|---|---|
| Symbol | CGA |
| Approved Name | glycoprotein hormones, alpha polypeptide |
| Target ID | ENSG00000135346 |
| Biotype | protein_coding |
| Association Score | 0.3559 |
| Gap Score | 0.0187 |
| Conservative Gap Score | 0.0234 |
| Gap Rank | 399 |
...
**Lower evidence signal** (association score: 0.3559)
...
- Symbol 'CGA' has a moderate ambiguity flag — mention counts are especially uncertain.
