...
|---|---|
| Symbol | ILF3 |
| Approved Name | interleukin enhancer binding factor 3 |
| Target ID | ENSG00000129351 |
| Biotype | protein_coding |
| Association Score | 0.3631 |
| Gap Score | 0.0241 |
| Conservative Gap Score | 0.0301 |
| Gap Rank | 380 |
...
**Lower evidence signal** (association score: 0.3631)
