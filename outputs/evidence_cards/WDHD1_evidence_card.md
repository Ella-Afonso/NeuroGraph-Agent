...
|---|---|
| Symbol | WDHD1 |
| Approved Name | WD repeat and HMG-box DNA binding protein 1 |
| Target ID | ENSG00000198554 |
| Biotype | protein_coding |
| Association Score | 0.4598 |
| Gap Score | 0.0958 |
| Conservative Gap Score | 0.1198 |
| Gap Rank | 174 |
...
**Lower evidence signal** (association score: 0.4598)
