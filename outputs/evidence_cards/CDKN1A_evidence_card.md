...
|---|---|
| Symbol | CDKN1A |
| Approved Name | cyclin dependent kinase inhibitor 1A |
| Target ID | ENSG00000124762 |
| Biotype | protein_coding |
| Association Score | 0.5503 |
| Gap Score | 0.1630 |
| Conservative Gap Score | 0.2037 |
| Gap Rank | 51 |
...
**Moderate evidence signal** (association score: 0.5503)
