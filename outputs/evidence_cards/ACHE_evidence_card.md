...
|---|---|
| Symbol | ACHE |
| Approved Name | acetylcholinesterase (Yt blood group) |
| Target ID | ENSG00000087085 |
| Biotype | protein_coding |
| Association Score | 0.6287 |
| Gap Score | 0.4768 |
| Conservative Gap Score | 0.4833 |
| Gap Rank | 5 |
...
**Moderate evidence signal** (association score: 0.6287)
...
In this retrieved literature corpus, the target symbol was detected 7 time(s) across 3 document(s).
...
ACHE appears well represented in both literature and trial text in this corpus. It should be treated as an established or trial-covered comparator rather than a gap candidate. It may serve as a reference point for comparing less-studied targets.
...
| --- | --- | --- | --- | --- |
| NCT00940589 | Efficacy of Circadin® 2 mg in Patients With Mild to Moderate Alzheimer Disease … | COMPLETED | PHASE2 | Neuroinflammation & Immune |
